...
describe('Given the uploadFileToCloud helper', () => {
  ...
  const cloudinaryReponse = {
    ...
    format: 'jpg',
    resource_type: 'image',
    created_at: '2022-06-12T19:01:40Z',
    tags: [],
    bytes: 132394,
    type: 'upload',
    etag: '34691c36e1bd8cba8b39df190f8d6c71',
    placeholder: false,
    url: 'http://res.cloudinary.com/manulk/image/upload/v1655060500/s3cmktctic1m9piw80cn.jpg',
    secure_url:
      'https://res.cloudinary.com/manulk/image/upload/v1655060500/s3cmktctic1m9piw80cn.jpg',
    access_mode: 'public',
